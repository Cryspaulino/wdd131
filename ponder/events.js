...
function newTask() {
  ...
  const task = document.querySelector("#todo").value; /*This brings the whole todo thing, if I want just the value I put dot value after the parenthesis.*/
...
function manageTasks(event) {
  ...
  //document.querySelector("#submitTask").removeEventListener("click", removeTask)
}
