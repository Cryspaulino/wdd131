...
function togglePaymentDetails(e) {
  ...
  const paypalContainer = document.getElementById("paypalUserContainer");
...
//  const theSelect = eTarget
  // Show the container based on the selected payment method, and add the required attribute back.
  //IN THE IF CAREFUL TO USE THE VALUE OF CREDITCARD
  if (theForm.theSelect.value === "creditCard") {
    creditCardContainer.classList.remove("hide");
    theForm.creditcard.setAttribute("required", "");
  }
  else if (theForm.theSelect.value === "paypal") {
    paypalContainer.classList.remove("hide");
    theForm.paypaluser.setAttribute("required", "");
  }
